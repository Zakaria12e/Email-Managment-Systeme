...
<body>
    ...
    <div class=" text-[#333] min-h-screen relative flex fle-col items-center justify-center py-6 px-4">
        ...
        <div class="grid md:grid-cols-2 items-center gap-10 max-w-6xl w-full">
            ...
            <div>
                <h2 class="lg:text-5xl text-4xl font-extrabold lg:leading-[55px]">
                    Inscription Transparente pour des Avantages Exclusifs
                </h2>
                <p class="text-sm mt-6">Soyez partie intégrante de notre <b>système de gestion des e-mails</b> dès votre inscription. Profitez d'un processus d'inscription fluide et débloquez des avantages exclusifs.</p>
            ...
            <form method="POST" action="{{ route('signup.store') }}" class=" md:max-w-lg md:ml-auto w-full relative">
                ...
                <div>
                    <div>
                        <label class="text-xs block mb-2">Nom Complet</label>
                        <div class="relative flex items-center">
                            <input name="name" type="text" required class="w-full bg-transparent rounded-md text-sm border-b border-gray-300 focus:border-[#333] px-2 py-3 outline-none" placeholder="Entrez votre nom" />
                    ...
                    <div class="mt-10">
                        ...
                        <div class="relative flex items-center">
                            <input name="email" type="text" required class="w-full bg-transparent rounded-md text-sm border-b border-gray-300 focus:border-[#333] px-2 py-3 outline-none" placeholder="Entrez votre email" />
