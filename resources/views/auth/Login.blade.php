          ...
          <div class="grid md:grid-cols-2 items-center gap-10 max-w-6xl w-full">
            <div class="max-md:text-center">
                <h2 class="lg:text-5xl text-4xl font-extrabold lg:leading-[55px]">
                    Connectez-vous pour gérer vos e-mails en toute simplicité
                </h2>

              <p class="text-sm mt-6">Plongez dans une expérience de <b> gestion d'e-mails </b> sans tracas avec notre formulaire de connexion intuitivement conçu. Accédez facilement à votre compte.</p>
